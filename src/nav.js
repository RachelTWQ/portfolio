  ...
  return (
    <>
      ...
      <header>
        ...
        <Link to='/' className="name-logo">Rachel Tang</Link>
        </div>
        ...
        <label htmlFor="main-menu-checkbox" className="menu-close">
          ...
          <ul>
            ...
            <li className="menu-item"><a href="https://resume.creddle.io/resume/e0p2fjjet2f" target="_blank" rel="noopener noreferrer">Resume</a></li>
            
            <li className="menu-item"><Link to="/contact">Say Hi</Link></li>
          </ul>
        </nav>
