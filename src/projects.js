    ...
    this.state = {
      projects: [
        ...
        },
        {
          ...
          "framework": "React, Express, Node, WebSockets, Webpack and babel"
        },
        {
          "id": 4,
          "name": "SOSFood",
          ...
          "language": "JavaScript, HTML, CSS",
          "framework": "Node, Express, AJAX, Twilio API, jQuery, HTML5, CSS3 and PostgreSQL"
        },
        {
          "id": 3,
          "name": "jungle-rails",
          "full_name": "RachelTWQ/jungle-rails",
          "description": "An e-commerce Rails app built for learning Rails through debugging and refractoring existing code. Users can place order and receive email notification.",
          "language": "Ruby, HTML, CSS",
          "framework": "Ruby on Rails, ERB, RSpec, Active Record, PostgreSQL and Stripe"
        },
        {
          "id": 2,
          "name": "tweeter",
        ...
        },
        {
          ...
          "language": "JavaScript",
          "framework": "Express, Node, EJS and Bootstrap"
        }
      ]
    };
  }
